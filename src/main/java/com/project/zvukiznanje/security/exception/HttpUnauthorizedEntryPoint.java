package com.project.zvukiznanje.security.exception;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.project.zvukiznanje.security.dto.UnauthorizedResponseDTO;
...
public class HttpUnauthorizedEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request,
      ...
      UnauthorizedResponseDTO unauthorizedResponseDTO=  new UnauthorizedResponseDTO(
              "Acces Denied!", authException.getMessage()
      );
